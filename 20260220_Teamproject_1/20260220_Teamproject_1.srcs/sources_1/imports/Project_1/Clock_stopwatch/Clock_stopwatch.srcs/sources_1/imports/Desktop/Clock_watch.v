...
module Top_stopwatch (
    ...
    clock_datapath U_CLOCK_DATAPATH (
        ...
        .sec_up   (w_sec_up),
        .sec_down (w_sec_down),
        .msec     (w_clock_time[7:0]),
        .sec      (w_clock_time[15:8]),
        .min      (w_clock_time[23:16]),
        .hour     (w_clock_time[31:24])
    );
    ...
    stopwatch_datapath U_STOPWATCH_DATAPATH (
        ...
        .hour    (w_stopwatch_time[31:24])  //6bit
    );
...
module mux_2 (
    input [31:0] mux_in_stop,
    input [31:0] mux_in_clock,
    input mode,
    output [31:0] mux_out
);
