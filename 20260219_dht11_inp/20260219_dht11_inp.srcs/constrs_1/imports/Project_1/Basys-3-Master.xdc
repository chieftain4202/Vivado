...
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports {sw}]
...
#set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {bnt_c}]


## LEDs
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports {vaild}]
...
#set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports {dhtio}];#Sch name = JC4
...
set_property -dict { PACKAGE_PIN N2   IOSTANDARD LVCMOS33 } [get_ports {dhtio}];#Sch name = XA4_P
